...
export default defineComponent({
  setup() {
    ...
    return () => (
      <div class={s.wrapper}>
        <el-form rules={rules} model={ruleForm} label-width={'100px'} ref={ruleFormRef}>
          <el-form-item label={'姓名'} prop={'name'}>
            <el-input v-model={ruleForm.name} />
          </el-form-item>
          <el-form-item label={'地址'} prop={'region'}>
            <el-select v-model={ruleForm.region} placeholder={'Please select city'}>
          ...
          <el-form-item label={'日期'} prop={'date1'}>
            <el-date-picker v-model={ruleForm.date1} type={'date'} placeholder={'Select date'} />
          </el-form-item>
          <el-form-item label={'性别'} prop={'delivery'}>
            <el-switch v-model={ruleForm.delivery} active-text={"女"} inactive-text={"男"} />
          </el-form-item>
          <el-form-item>
